...
## Status: Draft — revised after proposal review (P1×4 + P2×4 fixes inlined)
...
**Note:** `ADR-AUDIO-011 — Always-on capture with engagement gate` and the supersession edit on `ADR-AUDIO-009` ride with this proposal's merge to `main` per CLAUDE.md "Proposal and ADR Commit", **before** any of the implementation tasks T1–T5 begin.
